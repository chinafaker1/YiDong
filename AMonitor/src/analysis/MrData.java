...
//		sBuilder.append("MR_PRB加权期望区间:"+indexExpPrbNum+"\n");
	...
	public MrData(double[] RSRP,double[] RSRQ,double[] PlrUl6,double[] PlrUl8,double[] PlrUl9,double[] PlrDl6,double[] PlrDl8,double[] PlrDl9,double[] SinrUl)
	{
		/**
		 * 数据初始化
		 */
...
//		
		...
		this.setMrRsrp(RSRP);
		this.setMrRsrq(RSRQ);
		this.setMrPlrUl6(PlrDl6);
		this.setMrPlrUl8(PlrDl8);
		this.setMrPlrUl9(PlrDl9);
		this.setMrPlrDl6(PlrUl6);
		this.setMrPlrDl8(PlrUl8);
		this.setMrPlrDl9(PlrUl9);
		this.setMrSinrUl(SinrUl);
		/**
		 * 数据初始化
		 */
...
//		indexExpPrbNum=Util.getPrbNumIndex(expMrPrbNum);
		...
		System.out.println(mrSinrUl);
		System.out.println(expMrSinrUl);
