...
import cn.com.taiji.tongji.manager.comm.handler.BinFileServiceHandler;
import cn.com.taiji.tongji.manager.comm.handler.SampleBinFileServiceHandler;
...
public class BinFileCommHandleManager extends AbstractHttpFileCommHandleManager implements HttpFileCommHandleManager
{
	...
	@Autowired
	private SampleBinFileServiceHandler sampleHandler;
	...
	protected FileProtocolResponse handleRequest(String filename, InputStream fs, HttpServletRequest request)
	{
		...
		if (serviceType == null) return FileProtocolError.NOT_SUPPORT.newResponse(filename);
