...
public class MyFileCommHandleListener extends AbstractManager implements FileCommHandleListener
{
	...
	private void handleProtocol(AbstractFileProtocol protocol)
	{
		String namePrefix = protocol instanceof FileProtocolRequest ? "request" : "response";
		String fileName = namePrefix + protocol.getFilename();
