...
@EnableJpaRepositories(basePackages = "cn.com.taiji." + AppConfig.APP_NAME
		+ ".repo.jpa", entityManagerFactoryRef = "entityManager", transactionManagerRef = "txManager", repositoryFactoryBeanClass = MyJpaRespositoryFactoryBean.class)
...
{
	public static final String APP_NAME = "tongji";
...
//			vendorAdapter.setShowSql(true);
	...
	private Properties additionlProperties()
	{
		...
		props.setProperty("hibernate.default_schema", schema);// 设置默认schema
		return props;
	}
